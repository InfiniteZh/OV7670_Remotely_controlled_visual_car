...
`define end_rdburst		cnt_clk		== sdrd_byte-4//TREAD_CLK-4		//·¢³öÍ»·¢¶ÁÖÐ¶ÏÃüÁî
`define	end_tread		cnt_clk_r	== sdrd_byte+2//TREAD_CLK+2		//TREAD_CLK+2
`define end_wrburst		cnt_clk		== sdwr_byte-1//TWRITE_CLK-1	//·¢³öÍ»·¢Ð´ÖÐ¶ÏÃüÁî
